;; Use the doom-gruvbox dark theme with the hard contrast variant
...
;; Set the default font and size (units are 1/10 pt, so 140 = 14pt)
(set-face-attribute 'default nil :family "FiraCode Nerd Font" :height 140)

;; Add extra spacing between lines for improved readability (in pixels)
(setq-default line-spacing 2)

;; Highlight the current line to make the cursor position easier to track
